...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body id="page-top">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="login/login.aspx">Login</a>
            </li>
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about">About</a>
            </li>
            <li class="nav-item mx-0 mx-lg-1">
              <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="Home.aspx">Home</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        <img class="img-fluid mb-5 d-block mx-auto" src="img/main.png" alt="">
        <h1 class="text-uppercase mb-0">SMART HR</h1>
        <hr class="star-light">
        <h2 class="font-weight-light mb-0">Request Document - Request Cuti - Reimburse</h2>
      </div>
    </header>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4">
            <a class="portfolio-item d-block mx-auto" href="#portfolio-modal-3">
              ...
              <img class="img-fluid" src="img/overtime.png" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
            <a class="portfolio-item d-block mx-auto" href="#portfolio-modal-4">
              ...
              <img class="img-fluid" src="img/Reimburse.png" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 ml-auto">
            ...
            <p class="lead">"SAVE PAPER. Good for your planet. Good for your Business"</p>
          </div>
          <div class="col-lg-4 mr-auto">
            <p class="lead"> 1. pengajuan cuti yg dapat diakses dimanapun tanpa harus pengajuan raimbursment lembur, medical, transport dll 
