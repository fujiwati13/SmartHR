                            ...
                            <form id="Form1" action="#" method="post" runat="server">
								...
								ErrorMessage="Please Fill Gender!" InitialValue=""></asp:RequiredFieldValidator></font>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtPhone" TextMode="Number" CssClass="inptype" runat="server"></asp:TextBox>
                                                <font color="red">*)<asp:RequiredFieldValidator id="Requiredfieldvalidator8" runat="server" Display="Dynamic" ControlToValidate="txtPhone"
								ErrorMessage="Please Fill Phone!" InitialValue=""></asp:RequiredFieldValidator></font>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtEmail" CssClass="inptype" runat="server"></asp:TextBox>
                                                <font color="red">*)<asp:RequiredFieldValidator id="Requiredfieldvalidator9" runat="server" Display="Dynamic" ControlToValidate="txtEmail"
