                            ...
                            <form id="Form1" action="#" method="post" runat="server">
								...
								ErrorMessage="Please Fill Approval Type!" InitialValue=""></asp:RequiredFieldValidator></font></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtApprovalLevel" runat="server" TextMode="Number" CssClass="inptype"></asp:TextBox>
                                                <font color="red">*)<asp:RequiredFieldValidator id="Requiredfieldvalidator4" runat="server" Display="Dynamic" ControlToValidate="txtApprovalLevel"
