<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Overtime/Overtime.Master" CodeBehind="InquiryOvertime.aspx.vb" Inherits="SmartHR.InquiryOvertime" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <form id="Form1" action="#" method="post" runat="server">
        <h2>Inquiry Overtime</h2>
        <br />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn SortExpression="Status" HeaderText="Status">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblAttachment" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container, "DataItem.BuktiTransferName")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="View Detail">
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton CommandName="View" ID="lnkbAction" CausesValidation="false" runat="server">ViewDetail</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
            ...
            <asp:Panel ID="pnlGrid" runat="server">
                <table cellspacing="0" cellpadding="0" width="95%" align="center" border="0">
                    <tr>
                        ...
                        <td class="tdtopi" align="center">Overtime Detail</td>
