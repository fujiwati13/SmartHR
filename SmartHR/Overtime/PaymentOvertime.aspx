<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Overtime/Overtime.Master" CodeBehind="PaymentOvertime.aspx.vb" Inherits="SmartHR.PaymentOvertime" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="Form1" action="#" method="post" runat="server">
        <h2>Payment Overtime</h2>
        <br />
                        ...
                        <asp:DataGrid ID="dtgList" runat="server" CssClass="tablegrid" DataKeyField="ReqOvertimeNo" CellSpacing="1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="ACTION">
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton CommandName="Payment" ID="lnkbAction" CausesValidation="false" runat="server">Payment</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
                        </asp:DataGrid>
        ...
        <asp:Panel runat="server" ID="pnlDetail" Visible="true">
            ...
            <table border="0" width="95%">
                <tr runat="server" id="trNextApv">
                    ...
                    <td width="30%">
                        <h5>
                            <asp:Label runat="server" ID="Label8">Payment Confirmation</asp:Label></h5>
                    </td>
                    <td width="2%">
