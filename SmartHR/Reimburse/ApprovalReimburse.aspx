<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Reimburse/Reimburse.Master" CodeBehind="ApprovalReimburse.aspx.vb" Inherits="SmartHR.ApprovalReimburse" %>
                        ...
                        <asp:DataGrid ID="dtgList" runat="server" CssClass="tablegrid" DataKeyField="RaimburseNo" CellSpacing="1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Action">
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton CommandName="Approve" ID="lnkApprove" CausesValidation="false" runat="server">Approve</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
                        </asp:DataGrid>
