...
#End Region
    ...
    Private Sub imbSearch_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imbSearch.Click
        ...
        Me.SortBy = ""
        lblMessage.Text = ""
        Me.CmdWhere = " R.EmployeeID='" & Me.EmployeeID & "' And "
    ...
    Protected Sub BindData(ByVal CmdWhere As String)
        ...
        Using con As New SqlConnection(constr)
            Using cmd As New SqlCommand("spPagingRequestReimburse")
                cmd.Connection = con
                cmd.CommandType = CommandType.StoredProcedure
    ...
    Protected Sub btnsave_Click(sender As Object, e As EventArgs)
        ...
        cmd1.Parameters.Add(New SqlParameter("@KodeTransaksi", "ATC"))
        Dim paramOut As New SqlParameter("@NewNumber", SqlDbType.VarChar, 20)
        paramOut.Direction = ParameterDirection.Output
        cmd1.Parameters.Add(paramOut)
        cmd1.CommandText = "spGenerateNumber"
        conn.Open()
        cmd1.ExecuteNonQuery()
        conn.Close()

        Me.AttachmentID = paramOut.Value
        Try
            Using con As New SqlConnection(constr)
                Using cmd As New SqlCommand("spSaveRequestReimburse")
                    Using sda As New SqlDataAdapter()
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Parameters.AddWithValue("@EmployeeID", Me.EmployeeID)
                        cmd.Parameters.AddWithValue("@RaimburseID", ddlReimburseType.SelectedValue)
                        cmd.Parameters.AddWithValue("@AmountRaimburse", txtAmountReimburse.Text.Trim())
            ...
            Mail()
            Reset()
            lblMessage.Text = "Save Successfully Your Request No : " & Me.ReqNo & ", Please Upload File Attachment!"
    ...
    Protected Sub btnCancel_Click(sender As Object, e As EventArgs)
        Response.Redirect("RequestReimburse.aspx")
    End Sub
...
#End Region
    ...
    Sub Reset()
        ...
        ddlReimburseType.SelectedValue = ""
        txtAmountReimburse.Text = ""
    End Sub
