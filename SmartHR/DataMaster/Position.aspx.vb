...
#End Region
    ...
    Protected Sub BindData(ByVal CmdWhere As String)
        ...
        Using con As New SqlConnection(constr)
            Using cmd As New SqlCommand("spPagingPosition")
                cmd.Connection = con
...
#End Region
    ...
    Private Sub dtgList_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dtgList.ItemCommand
        ...
        Select Case e.CommandName
            Case "Edit"
                ...
                txtPositionID.Text = lblPositionID.Text
            ...
            Case "Delete"
                ...
                Try
                    Using con As New SqlConnection(constr)
                        Using cmd As New SqlCommand("spDeletePosition")
                            Using sda As New SqlDataAdapter()
                                cmd.CommandType = CommandType.StoredProcedure
                                cmd.Parameters.AddWithValue("@PositionID", lblPositionID.Text.Trim())
                                cmd.Connection = con
                                con.Open()
                                cmd.ExecuteNonQuery()
                                con.Close()
    ...
    Private Sub imbSearch_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imbSearch.Click
        ...
        If txtSearch.Text <> "" Then
            ...
            End If
            'If ddlSearch.SelectedItem.Value.Trim = "PositionID" Then
            '    If CBool(InStr(txtSearch.Text, "%")) Then
            '        CmdWhere = CmdWhere & CmdWhere & "PositionID like '" & txtSearch.Text.Trim & "' "
            '    Else
            '        CmdWhere = CmdWhere & "PositionID = '" & txtSearch.Text.Trim & "' "
            '    End If
            'ElseIf ddlSearch.SelectedItem.Value.Trim = "PositionName" Then
    ...
    Protected Sub btnsave_Click(sender As Object, e As EventArgs)
        Try
            Using con As New SqlConnection(constr)
                Using cmd As New SqlCommand("spSaveAddEditPosition")
                    Using sda As New SqlDataAdapter()
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Parameters.AddWithValue("@PositionID", txtPositionID.Text.Trim())
                        cmd.Parameters.AddWithValue("@PositionName", txtDescription.Text.Trim())
