...
#End Region
    ...
    End Sub
    Sub Reset()
        txtApprovalSchemeID.Enabled = True
        txtApprovalSchemeID.Text = ""
        txtDescription.Text = ""
        txtApprovalLevel.Text = "0"
        ddlApprovalType.SelectedValue = ""
    End Sub
    ...
    Private Sub dtgList_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dtgList.ItemCommand
        ...
        Select Case e.CommandName
            Case "Edit"
                ...
                txtApprovalSchemeID.Text = lblApprovalSchemeID.Text
                ...
                txtApprovalLevel.Text = lblApprovalLevel.Text

                lblAPprovalType = DirectCast(e.Item.FindControl("lblApprovalType"), Label)
                ddlApprovalType.SelectedValue = lblAPprovalType.Text

                txtApprovalSchemeID.Enabled = False
                pnlList.Visible = False
            ...
            Case "Delete"
                ...
                Try
                    Using con As New SqlConnection(constr)
                        Using cmd As New SqlCommand("spDeleteApprovalScheme")
                            Using sda As New SqlDataAdapter()
                                cmd.CommandType = CommandType.StoredProcedure
                                cmd.Parameters.AddWithValue("@ApprovalSchemeID", lblApprovalSchemeID.Text.Trim())
                                cmd.Connection = con
                                con.Open()
                                cmd.ExecuteNonQuery()
                                con.Close()
    ...
    Protected Sub btnsave_Click(sender As Object, e As EventArgs)
        Try
            Using con As New SqlConnection(constr)
                Using cmd As New SqlCommand("spSaveAddEditApprovalScheme")
                    Using sda As New SqlDataAdapter()
                        cmd.CommandType = CommandType.StoredProcedure
                        cmd.Parameters.AddWithValue("@ApprovalSchemeID", txtApprovalSchemeID.Text.Trim())
                        cmd.Parameters.AddWithValue("@Description", txtDescription.Text.Trim())
                        cmd.Parameters.AddWithValue("@ApprovalLevel", txtApprovalLevel.Text.Trim())
                        cmd.Parameters.AddWithValue("@ApprovalType", ddlApprovalType.SelectedValue.Trim())
...
#End Region
    ...
    Private Sub imbReset_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imbReset.Click
        Response.Redirect("ApprovalScheme.aspx")
    End Sub
End Class