                            ...
                            <form id="Form1" action="#" method="post" runat="server">
                                ...
                                <asp:Panel ID="pnlList" runat="server">
                                    <table border="1" cellspacing="0" cellpadding="0" width="95%" align="center">
                                        <tr>
                                            <td align="center" colspan="3" style="background-color: cadetblue; color: black">REIMBURSE LIMIT LIST</td>
                                        </tr>
                                    </table>
								...
								ErrorMessage="Please Fill Golongan!" InitialValue=""></asp:RequiredFieldValidator></font>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <font color="red">*)<asp:rangevalidator id="Rangevalidator25" runat="server" ErrorMessage="Insert numeric!" ControlToValidate="txtMaxAmount"
										Display="Dynamic" MinimumValue="0" Type="Double" MaximumValue="999999999999999.99"></asp:rangevalidator><asp:RequiredFieldValidator id="Requiredfieldvalidator2" runat="server" Display="Dynamic" ControlToValidate="txtMaxAmount"
