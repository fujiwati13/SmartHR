    ...
    <form id="Form1" action="#" method="post" runat="server">
        ...
        <asp:Panel ID="pnlList" runat="server">
            <table border="1" cellspacing="0" cellpadding="0" width="95%" align="center">
                <tr>
                    <td align="center" colspan="3" style="background-color: cadetblue; color: black">DOCUMENT LIST</td>
                </tr>
            </table>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn SortExpression="DocumentDesc" HeaderText="DocumentDesc">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblUserApproval" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container, "DataItem.UserApproval")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
