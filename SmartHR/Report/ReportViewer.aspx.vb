...
#End Region
    ...
    Dim RPTPath As String = System.Configuration.ConfigurationManager.AppSettings("ReportPath")
        ...
        Try
            ...
            Select Case Me.ReportType
                Case "L"
                    ...
                    ReportPath(RPTPath, "LeaveReport.rpt")
                Case "R"
                    spName = "spReimburseReport"
                    ReportPath(RPTPath, "ReimburseReport.rpt")
                Case "O"
                    spName = "spOvertimereport"
                    ReportPath(RPTPath, "OvertimeReport.rpt")
                Case "D"
                    spName = "spDocumentReport"
                    ReportPath(RPTPath, "DocumentReport.rpt")
            End Select
            ...
            Using con As New SqlConnection(constr)
                Using cmd As New SqlCommand(spName)
                    cmd.Connection = con
            ...
            CRVARReport.ReportSource = ReportBind()
