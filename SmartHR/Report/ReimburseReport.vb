...
Public Class ReimburseReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartHR.ReimburseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReimburseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReimburseReport = New ReimburseReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
